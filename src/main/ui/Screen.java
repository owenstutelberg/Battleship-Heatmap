...
public class Screen {
    ...
    public Screen() {
        ...
        createPlacementDisplay();
        createHeatmapDisplay();
        createButtonDisplay();
    ...
    public void handleMouseClick(MouseEvent e) {
        buttonDisplay.handleMouseClick(e);
    }

    public void createPlacementDisplay() {
        ...
        placementGrid = new PlacementGrid(
                new Vec2d(placementDisplay.getInteriorCorner(Corner.TOP_LEFT)),
                10,
                10,
                new Vec2d(500, 500));
    ...
    public void createHeatmapDisplay() {
        ...
        heatmap = new HeatmapGrid(
                new Vec2d(heatmapDisplay.getInteriorCorner(Corner.TOP_LEFT)),
                10,
                10,
                new Vec2d(500, 500),
                placementGrid,
    ...
    public void createButtonDisplay() {
        ...
        clearButton = new Button(
                buttonDisplay.getInteriorCorner(Corner.TOP_LEFT).add(new Vec2d(5, 5)),
        ...
        destroyerButton = new Button(
                buttonDisplay.getInteriorCorner(Corner.TOP_LEFT).add(new Vec2d(110, 5)),
                new Dimension(104, 50),
                buttonDisplay.getRadius() - 2 * buttonDisplay.getBorderLength(),
        ...
        submarineButton = new Button(
                buttonDisplay.getInteriorCorner(Corner.TOP_LEFT).add(new Vec2d(219, 5)),
                new Dimension(155, 50),
                buttonDisplay.getRadius() - 2 * buttonDisplay.getBorderLength(),
                Constants.ACTIVE_SHIP_COLOR,
                () -> {
        ...
        cruiserButton = new Button(
                buttonDisplay.getInteriorCorner(Corner.TOP_LEFT).add(new Vec2d(379, 5)),
                new Dimension(155, 50),
                buttonDisplay.getRadius() - 2 * buttonDisplay.getBorderLength(),
                Constants.ACTIVE_SHIP_COLOR,
                () -> {
        ...
        battleshipButton = new Button(
                buttonDisplay.getInteriorCorner(Corner.TOP_LEFT).add(new Vec2d(539, 5)),
                new Dimension(207, 50),
                buttonDisplay.getRadius() - 2 * buttonDisplay.getBorderLength(),
                Constants.ACTIVE_SHIP_COLOR,
                () -> {
        ...
        carrierButton = new Button(
                buttonDisplay.getInteriorCorner(Corner.TOP_LEFT).add(new Vec2d(751, 5)),
                new Dimension(259, 50),
                buttonDisplay.getRadius() - 2 * buttonDisplay.getBorderLength(),
                Constants.ACTIVE_SHIP_COLOR,
                () -> {
    ...
    public void createTextBoxes() {
        clearText = new TextBox(
                new Vec2d(buttonDisplay.getInteriorCorner(Corner.BOTTOM_LEFT).add(new Vec2d(31.5, -22.5))),
                "Clear");
        destroyerText = new TextBox(
                new Vec2d(buttonDisplay.getInteriorCorner(Corner.BOTTOM_LEFT).add(new Vec2d(118, -22.5))),
                "Destroyer");
        submarineText = new TextBox(
                new Vec2d(buttonDisplay.getInteriorCorner(Corner.BOTTOM_LEFT).add(new Vec2d(247, -22.5))),
                "Submarine");
        cruiserText = new TextBox(
                new Vec2d(buttonDisplay.getInteriorCorner(Corner.BOTTOM_LEFT).add(new Vec2d(423.5, -22.5))),
                "Cruiser");
        battleshipText = new TextBox(
                new Vec2d(buttonDisplay.getInteriorCorner(Corner.BOTTOM_LEFT).add(new Vec2d(596, -22.5))),
                "Battleship");
        carrierText = new TextBox(
                new Vec2d(buttonDisplay.getInteriorCorner(Corner.BOTTOM_LEFT).add(new Vec2d(849.5, -22.5))),
                "Carrier");
    }
}
